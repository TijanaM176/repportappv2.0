...
import { ProductionLine, ReportData, TimeOption } from '../../models/models';
...
@Component({
  ...
  imports: [FormsModule, CommonModule, CascadeSelect, DatePicker, Dialog, SelectButton, Button, Select],
        ...
        if (line.endDate == null) {
          ...
          if (groupKey && grouped[groupKey]) {
            ...
            grouped[groupKey].push({
              name: line.project,
              productionLine: line  // Čuvamo ceo objekat
            });
          }
        }
      });
      
      // CASCADE FORMAT: svaka grupa ima 'name' i 'children'
